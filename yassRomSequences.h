...
#define YASS_ROM_SEQUENCE_MAJOR_ARPEGGIO    10
#define YASS_ROM_SEQUENCE_MNOR_ARPEGGIO     11
#define YASS_ROM_SEQUENCE_DIM_ARPEGGIO      12
#define YASS_ROM_SEQUENCE_OXYGENE_4         13
#define YASS_ROM_SEQUENCE_PAN_TEST          14

#define YASS_ROM_SEQUENCE_FIRST             YASS_ROM_SEQUENCE_BILLIE_JEAN
#define YASS_ROM_SEQUENCE_LAST              YASS_ROM_SEQUENCE_PAN_TEST
