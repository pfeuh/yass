...
#define YASS_SEQUENCE_DEFAULT_NOTE      48
#define YASS_SEQUENCE_DEFAULT_DATA      100
#define YASS_SEQUENCE_DEFAULT_GROOVE    YASS_SEQUENCE_CROCHE
#define YASS_SEQUENCE_DEFAULT_GATE_TIME YASS_SEQUENCE_GATE_NORMAL
#define YASS_SEQUENCE_DEFAULT_DATA_MODE YASS_DATA_MODE_NONE
...
void YASS_SEQUENCE::initialize()
{
    ...
    gateMode = YASS_SEQUENCE_DEFAULT_GATE_TIME;
